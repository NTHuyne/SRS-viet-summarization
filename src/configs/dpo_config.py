...
def get_dpo_config(
    ...
    **kwargs
    ...
    """
    Get DPO configuration for training
    ...
    Args:
        ...
        loss_type: DPO loss type (sigmoid, hinge, ipo, kto_pair, etc.)
...
DPO_LOSS_TYPES = [
    ...
    "kto_pair",     # KTO for paired data
    "bco_pair",     # Binary Classifier Optimization
    "sppo_hard",    # Self-Play Preference Optimization
    "nca_pair",     # Normalized Calibrated Advantage
    "aot_pair",     # Advantage-based Optimization
    "aot",          # AOT unpaired variant
    "apo_zero",     # APO-zero
    "apo_down",     # APO with downweighting
]
